                  ...
                  <div key={pu.id} className="flex items-center gap-4 bg-gray-900/70 rounded-lg p-4 border border-cyan-700/20">
                    <div className="relative">
                      <img
                        ...
                        style={{ background: 'rgba(0,255,255,0.08)', borderRadius: 12 }}
                      />
                      <span
                        className="absolute right-0 bottom-0 translate-x-1/4 translate-y-1/4 bg-cyan-600 text-white text-xs font-bold rounded-full px-2 py-0.5 border-2 border-white shadow-lg select-none"
